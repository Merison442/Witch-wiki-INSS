...
body .site-title, body .header-logo.index6 .site-title , body .navbar.navbar7 .site-title{
	font-size:<?php echo esc_html(get_theme_mod('site_title_fontsize','36')).'px'; ?> ;
	font-family:<?php echo esc_html(get_theme_mod('site_title_fontfamily','Open Sans')); ?> ;
    line-height:<?php echo esc_html(get_theme_mod('site_title_line_height','46')).'px'; ?> ;
}
body .site-description {
	font-size:<?php echo esc_html(get_theme_mod('site_tagline_fontsize','20')).'px'; ?>;
	font-family:<?php echo esc_html(get_theme_mod('site_tagline_fontfamily','Open Sans')); ?>;
    line-height:<?php echo esc_html(get_theme_mod('site_tagline_line_height','37')).'px'; ?>;
}
body .navbar .nav > li > a {
	font-size:<?php echo esc_html(get_theme_mod('menu_title_fontsize','16')).'px'; ?>;
	font-family:<?php echo esc_html(get_theme_mod('menu_title_fontfamily','Open Sans')); ?> ;
     line-height:<?php echo esc_html(get_theme_mod('menu_line_height','30')).'px'; ?>;
}
body .dropdown-menu .dropdown-item{
	font-size:<?php echo esc_html(get_theme_mod('submenu_title_fontsize','16')).'px'; ?>;
	font-family:<?php echo esc_html(get_theme_mod('submenu_title_fontfamily','Open Sans')); ?>;
    line-height:<?php echo esc_html(get_theme_mod('submenu_line_height','30')).'px'; ?>;
}
</style>
<?php }
...
body .slider-caption h1.title  {
	font-size:<?php echo esc_html(get_theme_mod('slider_title_fontsize','65')).'px'; ?>;
...
<style>
 body .section-header p {
	...
	font-family:<?php echo esc_html(get_theme_mod('section_description_fontfamily','Open Sans')); ?>;
...
body .section-header h2, body .contact .section-header h2 {
   font-size:<?php echo esc_html(get_theme_mod('section_title_fontsize','36')).'px'; ?> !important;
	font-family:<?php echo esc_html(get_theme_mod('section_title_fontfamily','Open Sans')); ?>;
...
body .comment-title h3, body .comment-reply-title{
	font-size:<?php echo esc_html(get_theme_mod('h3_typography_fontsize','24')) + 4 .'px'; ?>;
	font-family:<?php echo esc_html(get_theme_mod('h3_typography_fontfamily','Open Sans')); ?>;
    line-height:<?php echo esc_html(get_theme_mod('h3_line_height','36')).'px'; ?> !important;
}
...
body .product-price h5, body .blog-author h5, body .comment-detail h5, body .entry-content h5, body .about h5, body .service h5, body .contact h5, body .navbar .nav > li > h5 {
	font-size:<?php echo esc_html(get_theme_mod('h5_typography_fontsize','18')).'px'; ?>;
...
body .entry-content p, body .cta-block p, body .about-content p, body .funfact p, body .woocommerce-product-details__short-description p, body .wpcf7 .wpcf7-form p label, body .testimonial .testmonial-block .designation, body .about p, body .entry-content li, body .contact address, body .contact p, body .service p, body .contact p, body .error-page p, body .logged-in-as, body .comment-form-comment label, body .comment-form-comment #comment, body .comment-detail p, body .navbar .nav > li > p{
	font-size:<?php echo esc_html(get_theme_mod('p_typography_fontsize','16')).'px'; ?>;
...
body .slider-caption p, body .slider-caption .description{
	font-size:<?php echo esc_html(get_theme_mod('p_typography_fontsize','16')) + 2 .'px'; ?>;
	font-family:<?php echo esc_html(get_theme_mod('p_typography_fontfamily','Open Sans')); ?>;
     line-height:<?php echo esc_html(get_theme_mod('p_line_height','30')).'px'; ?> !important;
}
...
.entry-header h2{
	...
	font-family:<?php echo esc_html(get_theme_mod('post-title_fontfamily','Open Sans')); ?>;
...
/* Shop Page H1 */
 body .woocommerce div.product .product_title{
	font-size:<?php echo esc_html(get_theme_mod('shop_h1_typography_fontsize','36')).'px'; ?>;
	font-family:<?php echo esc_html(get_theme_mod('shop_h1_typography_fontfamily','Open Sans')); ?>;
    line-height:<?php echo esc_html(get_theme_mod('shop_h1_line_height','54')).'px'; ?>;
}
...
<style>
  body h1 {
    ...
    body .sidebar .widget-title {
    	...
    	color: <?php echo esc_html(get_theme_mod('sidebar_widget_title_color','#ffffff')); ?>;
    }
    ...
    body .sidebar a, body #wrapper .sidebar .woocommerce a {
		...
		body.dark .sidebar a, body.dark #wrapper .sidebar .woocommerce a {
			color: <?php echo esc_html(get_theme_mod('sidebar_widget_link_color','#ffffff')); ?>;
		}
</style>
    <?php
...
<style type="text/css">
   ...
   #wrapper .container{max-width: <?php echo esc_html(get_theme_mod('container_width','1140'));?>px;}
