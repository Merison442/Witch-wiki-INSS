...
class Cache_Controller
{
	...
	public function handle_actions()
	{
		...
		add_action( 'after_delete_post', [ $this, 'after_deleted_post' ], 10, 1 );
		add_action( 'delete_attachment', [ $this, 'after_deleted_post' ], 10, 1 );
	}
	...
	public function after_deleted_post() {

		$request  = new Request();
		$request->delete_all_cache();
