		...
		<div id="gocache-admin" class="wrap gocache-settings">
			...
			<div class="row">
				...
				<div class="main-content">
					...
					<div class="gocache-logo">
						<img src="<?= App::plugins_url( 'assets/images/logo-gocache.png' ); ?>">
					</div>
						...
						<table class="form-table">
							...
							<tr valign="top">
								...
								<td>
									<input type="password" class="regular-text"
										   ...
										   id="gocache_api_key"
										   name="<?= $setting->get_option_name( 'api_key' ); ?>"
							...
							<tr valign="top">
								...
								<td>
									...
									<p class="description"><?= ! $domain ? '—' : $domain; ?></p>

									<input type="hidden"
										   name="<?= $setting->get_option_name( 'domain' ); ?>"
										   value="<?= $domain ?>" />
								</td>
						</table>
				...
				<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" data-component="gocache-ajax">
					...
					<table data-component="clear" class="form-table">
						...
						<tr valign="top">
							...
							<td>
								<textarea class="large-text"
										  name="<?php echo $setting->get_option_name( 'override_url_domain' ); ?>"
										  placeholder="www.gocache.com.br"
										  id="gocache_override_url_domain" rows="5"><?php echo $setting->override_url_domain; ?></textarea>
