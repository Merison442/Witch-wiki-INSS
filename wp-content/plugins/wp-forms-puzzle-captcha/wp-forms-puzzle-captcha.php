    ...
    class WFPC_init {
        ...
        public function WFPC_puzzle_captcha_handler( $tag ) {
			...
			<span class="wpfc-slidercaptcha wpfc-card wpcf7-form-control-wrap <?php echo $tag->name; ?>">
				...
				<span class="wpfc-card-body"><span data-heading="<?php echo $wfpc_cf7_form['header_text']; ?>" data-slider="<?php echo $wfpc_cf7_form['slider_text']; ?>" data-tryagain="<?php echo $wfpc_cf7_form['try_again_text']; ?>" data-form="cf7" id="wpfc-captcha"></span></span>
			</span>
			<?php
			$html = ob_get_clean();
			return $html;
